...
Player.HEAD_X = 0;		  // Координата X головы
Player.HEAD_Y = 3 / 4 * Player.HEIGHT;  // Координата Y головы
Player.CHOKE_SPEED = 15;	// Скорость, с которой игрок задыхается
Player.BURN_SPEED = 30;	 // Скорость, с которой игрок горит
